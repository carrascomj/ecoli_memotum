...
if [[ "${GITHUB_EVENT_NAME}" == "pull_request" || "${GITHUB_REPOSITORY}" != "carrascomj/ecoli_memotum" ]]; then
...
echo "Your new report will be visible at https://carrascomj.github.io/ecoli_memotum in a moment."
